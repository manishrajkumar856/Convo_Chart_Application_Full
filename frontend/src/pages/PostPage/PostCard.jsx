  ...
  return (
    <div className="w-full relative px-1 md:px-5 overflow-hidden bg-[#ffffff] border border-[#a3a3a382] rounded-xl">
      ...
      <div
        ...
        className="absolute text-[#565656] cursor-pointer ease-in duration-300 hover:text-[#d31010fe] px-2 py-2 rounded-full hover:bg-[#c6c6c666] md:top-5 top-0 text-2xl right-0 md:right-5"
      >
        <MdDelete />
      </div>
